...
if PROJECT_ROOT.name == "app": # Fallback if run from dev env differently
    PROJECT_ROOT = PROJECT_ROOT.parent
AUDIODIR = PROJECT_ROOT / "frontend" / "audio"
...
async def main():
    ...
    for f in AUDIODIR.glob("followup_*.mp3"):
        try:
            f.unlink()
    ...
    print(f"Generating thinking audio in {AUDIODIR}...")
